...
public class People {
    ...
    public static People Find_people(String file, String Id, ArrayList<People> peopleset) throws IOException {
        ...
        while (scn.hasNextLine()) {
            ...
            if (!line_array[0].startsWith("1")) {
                ...
                if (fixedLinearray.equals(Id)) {
                    ...
                    if (isPeople) {
                        ppl = new People(fixedLinearray, line_array[1], line_array[2], Integer.parseInt(line_array[3]),
                ...
                if (isPeople) {
                    ppl = new People(line_array[0], line_array[1], line_array[2], Integer.parseInt(line_array[3]),
                            Integer.parseInt(line_array[4]),
                            (2022 - Integer.parseInt(line_array[5])));
                    peopleset.add(ppl);
                }
